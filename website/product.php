...
?>
    ...
    if(isset($_GET['c_id'])){
        ...
        $q = mysqli_query($codes, "SELECT * FROM `prodtform` WHERE `userid` = $cid");

        while($pcal = mysqli_fetch_array($q)){
    ?>
        <div class="col-sm-6 col-md-3 col-lg-3 p-b-35 isotope-item women">
            <!-- Block2 -->
            <div class="block2">
                <div class="block2-pic hov-img0">
                    <img src="../img/<?php echo $pcal[5]; ?>" width="200px"  height="300px"alt="IMG-PRODUCT">
